...
<p align="center">开源的 AI Coding Agent（zhengjr9 分支）。</p>
<p align="center">
...
> [!TIP]
> 二进制默认安装到 `~/.opencode/bin/opencode`。
...
**加入我们的社区** [GitHub Discussions](https://github.com/zhengjr9/opencode/discussions)
